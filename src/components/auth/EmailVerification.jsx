...
export default function EmailVerification() {
  ...
  //emailverification to bypasslogin
  const { isAuth, authInfo } = useAuth();
  //verify email after login to below useEffect hook
...
//handling OTP resend
  ...
  //allows entering otp without clicking in each box.
  useEffect(() => {
            ...
            {otp.map((_, index) => {
              return (
                <input
                  ...
                  className="w-12 h-12 border-2 dark:border-dark-subtle  
                  border-light-subtle darK:focus:border-white focus:border-primary rounded bg-transparent 
