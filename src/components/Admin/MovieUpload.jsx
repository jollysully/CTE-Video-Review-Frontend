...
export default function MovieUpload({ visible, onClose }) {
  ...
  //progress bar for upload(usually a flash as movie files arent that big)
  ...
  //video upload and error if none selected
  return (
  ...
  return (
    <div className="h-full flex items-center justify-center">
      <FileUploader
        ...
        types={["mp4", "avi", "webm", "mkv"]}
      >
        <label className="w-48 h-48 border border-dashed dark:border-dark-subtle 
